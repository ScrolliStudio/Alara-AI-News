...
export async function querySuggestor(
  ...
  await streamObject({
    model: getModel(),
    system: `As Alara, your AI-driven news assistant from Scrolli, your task is to generate a set of three queries that explore the subject matter more deeply, building upon the initial query and the information uncovered in its search results.
