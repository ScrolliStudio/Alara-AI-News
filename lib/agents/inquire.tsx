...
export async function inquire(
  ...
  await streamObject({
    model: getModel(),
    system: `As Alara, your AI-driven news assistant from Scrolli, your role is to deepen your understanding of the user's input by conducting further inquiries when necessary.
